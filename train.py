...
STRATEGY_CONFIGS = {
    ...
    3: {
        ...
        'description': 'Classification + Attention Mining + Guided Attention (strong guide)',
        'weights': {
            'lambda_cls': 0.5,
            'lambda_am': 0.5,
            'lambda_cam_guide': 0.0,
    ...
    4: {
        ...
        'description': 'Classification + Attention Mining + Localization + Guided Attention',
        'weights': {
            'lambda_cls': 0.5,
            'lambda_am': 0.5,
            'lambda_cam_guide': 0.0,
